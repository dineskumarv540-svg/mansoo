package com.yourquote.app.data.local

import com.yourquote.app.data.model.Category
import com.yourquote.app.data.model.Comment
import com.yourquote.app.data.model.NotificationItem
import com.yourquote.app.data.model.NotificationType
...
object SampleData {
    ...
    val sampleNotifications = listOf(
        ...
        NotificationItem("n4", NotificationType.FEATURED, "YourQuote Team", "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=200", "Your post was selected for 'Best Posts of the Week' 🎉", "3h ago")
    )
